describe(" Sauce Demo - Authentication Test Suite ", () => {
  ...
  it("Scenario 1 - Valid username and password", () => {
  ...
  it("Scenario 2 - Valid username and invalid password", () => {
    cy.get("[data-test=username]").type("standard_user");
  ...
  it("Scenario 3 - Invalid username and valid password", () => {
